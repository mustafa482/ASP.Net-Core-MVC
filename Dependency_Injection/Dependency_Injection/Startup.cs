...
namespace Dependency_Injection
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<ConsoleLog>();//Bele yazilisda hemise 1 nesne yaradir.
            //services.AddSingleton<ConsoleLog>(p => new ConsoleLog(5));//Eger constructor deger alan dirsa onda bele yazilmalidi.
